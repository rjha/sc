...
j.ajax({url:K,dataType:L.dataType,complete:function M(N,O){D=(typeof(N.isResolved)!=="undefined")?(N.isResolved()):(O==="success"||O==="notmodified");
if(D){response="<div>"+N.responseText+"</div>";
L.state.nextUrl=j(response).find(L.nextSelector).attr("href");
