...
webgloo.sc.dashboard={itemContainer:"",showMessage:function(b,a){$("#page-message").html(b);
...
$("#page-message").hide();
$(c).show("slow");
}else{var d="No items have been selected. Please select some items to do this action.";
$("#page-message").html(d);
$("#page-message").show("slow");
window.setTimeout(function(){$("#page-message").hide("slow");
},5000);
