...
webgloo.sc.Lists={containerId:"",debug:false,populateSubmitForm:function(b,a,c){frm=document.forms["list-form1"];
frm.items_json.value=JSON.stringify(b);
if(a){frm.list_id.value="";
frm.is_new.value=1;
}else{frm.list_id.value=c;
frm.is_new.value=0;
}if(webgloo.sc.Lists.debug){console.log("items json = "+frm.items_json.value);
