...
case 401:a.qUrl=window.location.href;
a.method="POST";
g_action_data=encodeBase64(JSON.stringify(a));
...
a.params.action="ADD";
a.endPoint="/monitor/ajax/feature.php";
webgloo.sc.SimplePopup.init();
webgloo.sc.SimplePopup.post(a,{"dataType":"json"});
});
