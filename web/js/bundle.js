...
b.visible=(typeof b.visible==="undefined")?true:b.visible;
b.autoCloseInterval=(typeof b.autoCloseInterval==="undefined")?-1:b.autoCloseInterval;
b.reload=(typeof b.reload==="undefined")?false:b.reload;
b.type=(typeof b.type==="undefined")?"POST":b.type;
b.dataType=(typeof b.dataType==="undefined")?"text":b.dataType;
$.ajax({url:a.endPoint,type:b.type,dataType:b.dataType,data:a.params,timeout:9000,processData:true,error:function(d,c){webgloo.sc.SimplePopup.show(c);
},success:function(c){switch(b.dataType){case"json":webgloo.sc.SimplePopup.processJson(c,b,a);
break;
default:webgloo.sc.SimplePopup.show(c);
break;
}}});
...
webgloo.sc.SimplePopup.init();
webgloo.sc.SimplePopup.post(a,{"dataType":"json","autoCloseInterval":3000,"reload":true});
});
