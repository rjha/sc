...
webgloo.sc.dashboard={init:function(){$("input:checkbox[id=page-checkbox]").click(function(b){var a=$("#widgets").find("input:checkbox");
var c=$("input:checkbox[id=page-checkbox]").prop("checked");
a.prop("checked",c);
});
$("a#open-list-popup").click(function(e){var c=$("#widgets").find("input:checkbox");
var f;
var a=[];
c.each(function(g){f=$(this).prop("checked");
if(f){a.push($(this).attr("id"));
}});
if(a.length>0){var b={};
b.params={};
b.params.items=JSON.stringify(a);
b.params.qUrl=encodeBase64(window.location.href);
b.endPoint="/user/popup/list/select.php";
webgloo.sc.SimplePopup.init();
webgloo.sc.SimplePopup.post(b,{"dataType":"text","reload":false});
}else{var d="You have not selected any item! Please select an item.";
webgloo.sc.SimplePopup.init();
webgloo.sc.SimplePopup.show(d);
}});
