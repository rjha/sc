...
$("a.remove-post").live("click",function(b){b.preventDefault();
var a={};
a.params={};
a.params.itemId=$(this).attr("id");
a.params.action="REMOVE";
...
webgloo.sc.Lists={itemContainer:"",debug:false,imageDataObj:{},populateSubmitForm:function(b,a,d){var g=document.forms["list-form1"];
