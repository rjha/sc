...
webgloo.sc.admin={addPanelItems:function(d){var e=d.split(",");
for(var c=0;
c<e.length;
c++){var b=jQuery.trim(e[c]);
if(b==""){continue;
}var a='<div class="item">'+' <input type="checkbox" name="g[]" checked ="checked" value="'+b+'"/>'+b+" </div>";
$("div#item-preview").prepend(a);
$("#new-item-box").val("");
}},addPanelEvents:function(){$("#new-item-box").keydown(function(a){if(a.which==13){a.preventDefault();
var b=jQuery.trim($("#new-item-box").val());
if(b==""){return;
}else{webgloo.sc.admin.addPanelItems(b);
}}});
