...
webgloo.sc.message={get:function(b,c){var a="";
if(webgloo.sc.message.hasOwnProperty(b)){a=webgloo.sc.message[b].supplant(c);
}return a;
}};
webgloo.sc.message.HELP_LIST_ITEM_URL="3mik item URL is the page address displayed "+" in your browser on item details page, like http://www.3mik.com/item/307853"+" copy and paste that item URL in the box";
...
webgloo.sc.message.FETCH_IMAGE_RESULT="{total} images found.&nbsp;&nbsp;Place your mouse over an image to select it. "+"&nbsp;&nbsp;Click Next after selecting images.";
...
webgloo.sc.message.POPUP_WAIT="<div> Please wait...</div> "+'<div> <img src="/css/asset/sc/round_loader.gif" alt="loading ..." /> </div>';
webgloo.sc.message.POPUP_LOGIN="<div> Redirecting to login page... </div> "+'<div> <img src="/css/asset/sc/round_loader.gif" alt="loader" /> </div>';
...
$("#block-spinner").html("");
var b=webgloo.sc.message.POPUP_WAIT;
...
webgloo.sc.SimplePopup.gotoUrl="/user/login.php?q="+encodeBase64(window.location.href)+"&g_session_action="+g_action_data;
var d=webgloo.sc.message.POPUP_LOGIN;
...
webgloo.sc.item={addAdminActions:function(){$("a.feature-post").click(function(b){b.preventDefault();
var a={};
a.params={};
...
$("a.unfeature-post").click(function(b){b.preventDefault();
var a={};
a.params={};
a.params.postId=$(this).attr("id");
...
},addActions:function(){$("a.like-post").live("click",function(b){b.preventDefault();
var a={};
a.params={};
...
$("a.save-post").live("click",function(b){b.preventDefault();
var a={};
a.params={};
a.params.itemId=$(this).attr("id");
...
$("a.unsave-post").live("click",function(b){b.preventDefault();
var a={};
a.params={};
a.params.itemId=$(this).attr("id");
a.params.action="UNSAVE";
a.endPoint="/qa/ajax/bookmark.php";
webgloo.sc.SimplePopup.init();
webgloo.sc.SimplePopup.post(a,{"dataType":"json","reload":true,"visible":false});
});
$("a.follow-user").live("click",function(c){c.preventDefault();
var d=$(this).attr("id");
var b=d.split("|");
var a={};
a.params={};
...
$("a.unfollow-user").live("click",function(c){c.preventDefault();
var d=$(this).attr("id");
var b=d.split("|");
var a={};
a.params={};
...
webgloo.sc.dashboard={itemContainer:"",showMessage:function(a){$("#page-message").html(a);
$("#page-message").show("slow");
},showActionBox:function(d){try{var c=jQuery.trim(d);
if(c==""){return;
}var b=JSON.parse(c);
if(b.hasOwnProperty("id")){$("#"+b["id"]).show();
}}catch(a){console.log("error : parsing action box string");
}},init:function(a){webgloo.sc.dashboard.itemContainer=a;
$("a.open-action").click(function(c){var b="#"+$(this).attr("rel");
$(".action-form").hide();
$("#page-message").html("");
$("#page-message").hide();
$(b).show("slow");
...
$("#page-message").hide();
$(c).show("slow");
}else{var d=webgloo.sc.message.SELECT_ITEM;
$("#page-message").html(d);
$("#page-message").show("slow");
window.setTimeout(function(){$("#page-message").hide("slow");
},5000);
}});
$("a.close-action").click(function(c){var b="#"+$(this).attr("rel");
$(b).hide("slow");
$("#page-message").html("");
$("#page-message").hide();
});
$("input:checkbox[id=page-checkbox]").click(function(c){var b=$("#"+webgloo.sc.dashboard.itemContainer).find("input:checkbox");
...
webgloo.sc.Lists={itemContainer:"",debug:false,imageDataObj:{},initAction:function(){$("a.show-list").click(function(c){c.preventDefault();
var a={};
a.params={};
var d=$(this).attr("id");
var b=d.split("|");
a.params.loginId=b[0];
a.params.itemId=b[1];
a.params.action="SHOW";
a.params.qUrl=encodeBase64(window.location.href);
a.endPoint="/user/popup/lists.php";
webgloo.sc.SimplePopup.init();
webgloo.sc.SimplePopup.post(a,{"dataType":"text","reload":false,"visible":true});
});
},populateSubmitForm:function(b,a,d){var g=document.forms["list-form1"];
...
},init:function(a){webgloo.sc.Lists.itemContainer=a;
$("#lists li a").live("click",function(d){var c=$(this).attr("id");
var b=webgloo.sc.dashboard.getCheckedItems(webgloo.sc.Lists.itemContainer);
...
}if(webgloo.sc.ImageSelector.num_selected==0){var a=webgloo.sc.message.SELECT_IMAGE;
webgloo.sc.ImageSelector.appendError(a);
return false;
}else{var a=webgloo.sc.message.get("UPLOAD_IMAGE",{"total":webgloo.sc.ImageSelector.num_selected});
webgloo.sc.ImageSelector.appendMessage(a,{});
var b=webgloo.sc.message.FB_SPINNER;
webgloo.sc.ImageSelector.appendMessage(b,{});
$("#image-preview").find(".container").each(function(d){var e=$(this).attr("id"),f=e.split("-"),c=f[1],g=webgloo.sc.ImageSelector.bucket[c];
if(g.selected){$.ajaxQueue({url:webgloo.sc.ImageSelector.uploadEndpoint,type:"POST",dataType:"json",data:{"qqUrl":g.srcImage},timeout:9000,processData:true,error:function(j,h){webgloo.sc.ImageSelector.processUploadError(h);
},success:function(h){if(webgloo.sc.ImageSelector.debug){console.log("upload response for image :: "+g.srcImage);
console.log(h);
}switch(h.code){case 401:webgloo.sc.ImageSelector.processUploadError(h.message);
break;
case 200:webgloo.sc.ImageSelector.processUpload(h);
break;
default:webgloo.sc.ImageSelector.processUploadError(h.message);
break;
}}});
}});
...
}else{var a=webgloo.sc.message.IMAGE_SIZE_ERROR;
...
if(webgloo.sc.ImageSelector.num_total>0){message=webgloo.sc.message.get("FETCH_IMAGE_RESULT",{"total":webgloo.sc.ImageSelector.num_total});
}else{message=webgloo.sc.message.NO_IMAGE;
...
var b=webgloo.sc.message.FETCH_IMAGE;
var d=webgloo.sc.message.FB_SPINNER;
webgloo.sc.ImageSelector.clearMessage();
webgloo.sc.ImageSelector.appendMessage(b,{});
...
},processUploadError:function(a){webgloo.sc.ImageSelector.upload_counter++;
var b=webgloo.sc.message.get("IMAGE_UPLOAD_ERROR",{"counter":webgloo.sc.ImageSelector.upload_counter,"message":a});
webgloo.sc.ImageSelector.appendError(b);
if(webgloo.sc.ImageSelector.debug){console.log(b);
}webgloo.sc.ImageSelector.populateFormData();
},processUpload:function(a){webgloo.sc.ImageSelector.upload_counter++;
var b=webgloo.sc.message.get("IMAGE_UPLOAD_RESULT",{"counter":webgloo.sc.ImageSelector.upload_counter});
webgloo.sc.ImageSelector.appendMessage(b);
if(webgloo.sc.ImageSelector.debug){console.log(b);
}mediaVO=a.mediaVO;
