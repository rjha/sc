...
},initPanel:function(b){var a=jQuery.trim(b);
if(a!=""){$("#"+a).show();
}$("a.open-panel").click(function(d){var c="#"+$(this).attr("rel");
$(".panel").hide();
$("#page-message").html("");
$("#page-message").hide();
$(c).show("slow");
});
$("a.close-panel").click(function(d){var c="#"+$(this).attr("rel");
$(c).hide("slow");
$("#page-message").html("");
$("#page-message").hide();
});
...
$("a.save-post").live("click",function(a){a.preventDefault();
...
webgloo.sc.dashboard={containerId:"",setContainer:function(a){webgloo.sc.dashboard.containerId=a;
},showMessage:function(a){$("#page-message").html(a);
$("#page-message").show("slow");
},init:function(){$("a.item-action").click(function(d){var b="#"+$(this).attr("rel");
$(".panel").hide();
var a=webgloo.sc.dashboard.getCheckedItems(webgloo.sc.dashboard.containerId);
if(a.length>0){$("#page-message").html("");
$("#page-message").hide();
$(b).show("slow");
}else{var c=webgloo.sc.message.SELECT_ITEM;
$("#page-message").html(c);
$("#page-message").show("slow");
window.setTimeout(function(){$("#page-message").hide("slow");
},5000);
}});
$("input:checkbox[id=page-checkbox]").click(function(b){var a=$("#"+webgloo.sc.dashboard.containerId).find("input:checkbox");
...
webgloo.sc.Lists={debug:false,containerId:"",setContainer:function(a){webgloo.sc.Lists.containerId=a;
},openPopup:function(b){var a={};
a.params={};
a.params.itemId=b;
...
webgloo.sc.SimplePopup.init();
webgloo.sc.SimplePopup.post(a,{"dataType":"text","reload":false,"visible":true});
},init:function(){$("a.show-list").click(function(a){a.preventDefault();
var b=$(this).attr("id");
webgloo.sc.Lists.openPopup(b);
});
$("#lists li a").live("click",function(b){var a=$(this).attr("id");
webgloo.sc.Lists.submitList(a);
});
$("#create-list").click(function(b){b.preventDefault();
var a=jQuery.trim($("#new-list-name").val());
if(a==""){return;
}webgloo.sc.Lists.submitName();
});
$("#delete-items").click(function(b){var a=webgloo.sc.dashboard.getCheckedItems(webgloo.sc.Lists.containerId);
if(a.length>0){webgloo.sc.Lists.submitDeleteItems(a);
}});
},submitDeleteItems:function(a){var b=document.forms["delete-item-form"];
b.items_json.value=JSON.stringify(a);
$("#form4").submit();
},submitList:function(a){var b=document.forms["list-form1"];
b.list_id.value=a;
b.is_new.value=0;
if(webgloo.sc.Lists.debug){console.log("item_id = "+b.item_id.value);
console.log("list Id = "+b.list_id.value);
console.log("is_new = "+b.is_new.value);
return;
}$("#list-form1").submit();
},submitName:function(){var a=document.forms["list-form1"];
a.list_id.value="";
a.is_new.value=1;
if(webgloo.sc.Lists.debug){console.log("item_id = "+a.item_id.value);
console.log("list Id = "+a.list_id.value);
console.log("is_new = "+a.is_new.value);
return;
}$("#list-form1").submit();
}};
