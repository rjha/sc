...
webgloo.sc.dashboard={init:function(){$("a#close-list-popup").click(function(a){$("#list-container").hide();
});
$("input:checkbox[id=page-checkbox]").click(function(b){var a=$("#widgets").find("input:checkbox");
var c=$("input:checkbox[id=page-checkbox]").prop("checked");
a.prop("checked",c);
});
$("a#open-list-popup").click(function(d){var b=$("#widgets").find("input:checkbox");
var e;
var a=[];
b.each(function(f){e=$(this).prop("checked");
if(e){a.push($(this).attr("id"));
}});
if(a.length>0){frm=document.forms["list-form1"];
frm.items_json.value=JSON.stringify(a);
$("#page-message").html("");
$("#page-message").hide();
$("#list-container").show();
}else{var c="You have not selected any item! Please select an item.";
$("#page-message").html(c);
$("#page-message").show();
window.setTimeout(function(){$("#page-message").hide();
},5000);
}});
