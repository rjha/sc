...
echo " 4. install and configure sphinx. create sphinx indexes."
echo " 5. get a copy of latest sc-app.inc file "
echo " 6. get a copy of latest sc_config.ini file , check values."
